...
Although the optimisations delivered in this project have already improved performance, further improvements have been identified to improve scaling to an even greater number of CPU cores.
